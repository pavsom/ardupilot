...
const AP_Scheduler::Task Sub::scheduler_tasks[] = {
    ...
    SCHED_TASK(read_rangefinder,      5,    100,  15),
    SCHED_TASK(update_altitude,       20,    100,  18),
    ...
    SCHED_TASK_CLASS(RC_Channels, (RC_Channels*)&sub.g2.rc_channels, read_aux_all,    10,  50,  30),
