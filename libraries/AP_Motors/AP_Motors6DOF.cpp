...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
    ...
    case SUB_FRAME_CUSTOM:
        ...
        break;
    case SUB_FRAME_YAWMAIN:
        _frame_class_string = "yawMain";
        // Put your custom motor setup here
        //                 Motor #              Roll Factor     Pitch Factor    Yaw Factor      Throttle Factor     Forward Factor      Lateral Factor  Testing Order
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              -1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              1.0f,           0,                  1.0f,               0,              2);
        ...
        add_motor_raw_6dof(AP_MOTORS_MOT_5,     0,              -1.0f,          0,              1.0f,               0,                  0,              5);
        add_motor_raw_6dof(AP_MOTORS_MOT_6,     0,              0,              0.2f,           0,                  0,                  -1.0f,           6);
        add_motor_raw_6dof(AP_MOTORS_MOT_7,     0,              1.0f,           0,              1.0f,               0,                  0,              7);
        add_motor_raw_6dof(AP_MOTORS_MOT_8,     0,              0,              0.2f,           0,                  0,                  1.0f,           8);
        break;
    case SUB_FRAME_YAWALL:
        _frame_class_string = "yawAll";
        // Put your custom motor setup here
        //                 Motor #              Roll Factor     Pitch Factor    Yaw Factor      Throttle Factor     Forward Factor      Lateral Factor  Testing Order
        add_motor_raw_6dof(AP_MOTORS_MOT_1,     0,              0,              -1.0f,          0,                  1.0f,               0,              1);
        add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,              0,              1.0f,           0,                  1.0f,               0,              2);
