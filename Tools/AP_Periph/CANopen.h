...
#define AP_CANOPEN_USE_EVENTS (defined(CH_CFG_USE_EVENTS) && CH_CFG_USE_EVENTS == TRUE)
...
#define CANOPEN_MAX_NUM_ESCS 8

class AP_CANopen_Driver : public CANSensor
...
public:
    ...
    static AP_CANopen *get_singleton() { return _singleton; }

private:
    static AP_CANopen *_singleton;

    AP_Int8 _num_poles;
    AP_CANopen_Driver *_driver;
};
namespace AP {
    AP_CANopen *canopen();
};
